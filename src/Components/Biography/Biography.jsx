...
const Biography = () => {
    return (
        <main id='Biography' className='main-bio grid grid-cols-3 justify-center items-center gap-5 p-10'>
            <h2 className='grid justify-center col-span-3 text-3xl'>Biography</h2>
            <article className='image-container col-span-1 rounded-lg'>
                <img className='profile-pic p-10 rounded-lg' src={Tamara} />
            </article>
            <article className='bio-container col-span-2 flex flex-col justify-center items-start w-full h-full gap-3 rounded-lg'>
                <section className='bio-inner-container p-5 w-full h-auto rounded-lg'>
                ...
                <section className='icon-container flex justify-start gap-1 rounded-lg'>
